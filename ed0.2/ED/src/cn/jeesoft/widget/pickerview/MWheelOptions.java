...
final class MWheelOptions {
	...
	private List<String> mOptionstime2Items;
	private List<String> mOptionstime3Items;
	...
	public void setPicker(List<String> options1Items,
		...
		this.mOptions1Items = options1Items == null ? new ArrayList<String>()
				: options1Items;
		this.mOptions2Items = options2Items == null ? new ArrayList<List<String>>()
				: options2Items;
		this.mOptions3Items = options3Items == null ? new ArrayList<List<List<String>>>()
				: options3Items;
		// 选项1
		wv_option1 = (LoopView) view.findViewById(R.id.j_options1);
		wv_option1.textsize=18F;
		...
		if (!mOptions2Items.isEmpty()) {
			...
			wv_option2.setListener(new LoopListener() {
				...
				public void onItemSelect(int item) {
					if (!mOptions3Items.isEmpty()) {
						wv_option3.setArrayList(mOptions3Items.get(
								wv_option1.getCurrentItem()).get(item));
						wv_option3.setCurrentItem(0);
					} else {
						doItemChange();
					}
	...
	public void setTimePicker(List<String> options1Items,
		...
		this.mOptions1Items = options1Items == null ? new ArrayList<String>()
				: options1Items;
		this.mOptionstime2Items = options2Items == null ? new ArrayList<String>()
				: options2Items;
		this.mOptionstime3Items = options3Items == null ? new ArrayList<String>()
				: options3Items;
		// 选项1
		wv_option1 = (LoopView) view.findViewById(R.id.j_options1);
		wv_option1.setArrayList(mOptions1Items);// 设置显示数据
		...
		// 选项1
		wv_option2 = (LoopView) view.findViewById(R.id.j_options2);
		wv_option2.setArrayList(mOptionstime2Items);// 设置显示数据
		wv_option2.setCurrentItem(0);// 初始化时显示的数据
		// 设置是否循环播放
		wv_option2.setLoop();
		...
		// 选项1
		wv_option3 = (LoopView) view.findViewById(R.id.j_options3);
		wv_option3.setArrayList(mOptionstime3Items);// 设置显示数据
		wv_option3.setCurrentItem(0);// 初始化时显示的数据
		// 设置是否循环播放
		wv_option3.setLoop();
		...
		if (mOptionstime2Items.isEmpty())
			view.findViewById(R.id.j_layout2).setVisibility(View.GONE);
		if (mOptionstime3Items.isEmpty())
			view.findViewById(R.id.j_layout3).setVisibility(View.GONE);
	...
	private void doItemChange() {
		if (mOnOptionChangedListener != null) {
			...
			mOnOptionChangedListener.onOptionChanged(view, option1, option2,
					option3);
		}
	}
