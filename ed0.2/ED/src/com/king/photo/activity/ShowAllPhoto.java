...
public class ShowAllPhoto extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(ResUtil.getLayoutID("plugin_camera_show_all_photo"));
		PublicWay.activityList.add(this);
		mContext = this;
		back = (Button) findViewById(ResUtil.getWidgetID("showallphoto_back"));
		cancel = (Button) findViewById(ResUtil.getWidgetID("showallphoto_cancel"));
		preview = (Button) findViewById(ResUtil.getWidgetID("showallphoto_preview"));
		okButton = (Button) findViewById(ResUtil.getWidgetID("showallphoto_ok_button"));
	...
	private class PreviewListener implements OnClickListener {
		public void onClick(View v) {
			if (Bimp.tempSelectBitmap.size() > 0) {
				...
				intent.setClass(ShowAllPhoto.this, PictureGalleryActivity.class);
				...
				.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (Bimp.tempSelectBitmap.size() >= PublicWay.num&&isChecked) {
							...
							Toast.makeText(ShowAllPhoto.this, ResUtil.getString("only_choose_num"), 200)
									.show();
							return;
						}
						...
						if (isChecked) {
							...
							okButton.setText(ResUtil.getString("finish")+"(" + Bimp.tempSelectBitmap.size()
									+ "/"+PublicWay.num+")");
						} else {
							button.setVisibility(View.GONE);
