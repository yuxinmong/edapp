	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(
					ResUtil.getLayoutID("plugin_camera_select_imageview"), parent, false);
			viewHolder.imageView = (ImageView) convertView
					.findViewById(ResUtil.getWidgetID("image_view"));
			viewHolder.toggleButton = (ToggleButton) convertView
					.findViewById(ResUtil.getWidgetID("toggle_button"));
			viewHolder.choosetoggle = (Button) convertView
					.findViewById(ResUtil.getWidgetID("choosedbt"));
...
//			viewHolder.imageView.setLayoutParams(lp);
		...
		if (path.contains("camera_default")) {
			viewHolder.imageView.setImageResource(ResUtil.getDrawableID("plugin_camera_no_pictures"));
		} else {
