...
import com.android.volley.toolbox.RequestStatisticsUtil;
        ...
        while (true) {
            ...
            try {
                ...
                if (!(request instanceof ImageRequest)) {
                    RequestStatisticsUtil.append(request.getUrl(), networkResponse.data == null ? 16 : networkResponse.data.length);
                }
