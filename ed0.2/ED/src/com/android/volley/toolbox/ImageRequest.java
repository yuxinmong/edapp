...
public class ImageRequest extends Request<Bitmap> {
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (bitmap == null) {
            ...
            Response<Bitmap> result = Response.success(bitmap, HttpHeaderParser.parseCacheHeaders(response));
            if (result.cacheEntry != null) {
                result.cacheEntry.ttl = System.currentTimeMillis() + 24 * 3600 * 1000;
                result.cacheEntry.softTtl = System.currentTimeMillis() + 24 * 3600 * 1000;
            }
            return result;
        }
    }
    ...
    @Override
    protected void deliverResponse(boolean intermediate, Bitmap response) {
        mListener.onResponse(intermediate, response);
    }
