...
public class HttpHeaderParser {
     ...
     *         not cacheable.
     */
    public static Cache.Entry parseCacheHeaders(NetworkResponse response, boolean alwaysInformCache) {
        ...
        if (headerValue != null) {
            ...
            for (int i = 0; i < tokens.length; i++) {
                ...
                if (!alwaysInformCache && (token.equals("no-cache") || token.equals("no-store"))) {
                    return null;
