...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, final ImageListener listener) {
        return get(requestUrl, listener, 0, 0, true);
    }
     ...
     */
    public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight, boolean shouldCache) {
        ...
        Request<?> newRequest = new ImageRequest(requestUrl, new Listener<Bitmap>() {
            @Override
            public void onResponse(boolean intermediate, Bitmap response) {
        ...
        newRequest.setShouldCache(shouldCache);
    ...
    public ImageContainer get(String requestUrl, final ImageListener listener, boolean shouldCache) {
        return get(requestUrl, listener, 0, 0, shouldCache);
    }
