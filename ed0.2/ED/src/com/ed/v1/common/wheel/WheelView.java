...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xff656d78;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xffcacad1;
	...
	private static int ADDITIONAL_ITEM_HEIGHT = 35;

	/** Text size */
	private static int TEXT_SIZE = 24;
	private static int VALUE_SIZE = 24;
	...
	private void initData(Context context) {
		...
		TEXT_SIZE = context.getResources().getDimensionPixelSize(R.dimen.small_font);
		VALUE_SIZE = context.getResources().getDimensionPixelSize(R.dimen.normal_font);
		ADDITIONAL_ITEM_HEIGHT = context.getResources().getDimensionPixelSize(R.dimen.button_padding);
	}
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.select_center);
		}
	...
	private void createLayouts(int widthItems, int widthLabel) {
		if (itemsLayout == null || itemsLayout.getWidth() > widthItems) {
			itemsLayout = new StaticLayout(buildText(isScrollingPerformed), itemsPaint, widthItems,
					...
					2, ADDITIONAL_ITEM_HEIGHT, false);
		} else {
		...
		if (widthLabel > 0) {
			if (labelLayout == null || labelLayout.getWidth() > widthLabel) {
				labelLayout = new StaticLayout(label, valuePaint,
						widthLabel, Layout.Alignment.ALIGN_NORMAL, 2,
...
//		drawShadows(canvas);
	...
	private void drawValue(Canvas canvas) {
		...
		if (labelLayout != null) {
			canvas.save();
			canvas.translate(itemsLayout.getWidth() + LABEL_OFFSET, bounds.top + ADDITIONAL_ITEM_HEIGHT/2);
		...
		if (valueLayout != null) {
			canvas.save();
			canvas.translate(0, bounds.top + scrollingOffset + ADDITIONAL_ITEM_HEIGHT/2);
	...
	private void drawItems(Canvas canvas) {
		...
		canvas.translate(0, - top + scrollingOffset + ADDITIONAL_ITEM_HEIGHT/2);
