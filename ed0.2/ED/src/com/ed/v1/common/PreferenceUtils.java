...
public class PreferenceUtils {
	...
	private String BP_HISTORY_SYNCHRONIZATION = "bp_syn";
	private String SUGER_HISTORY_SYNCHRONIZATION = "suger_syn";
	...
	public void setBpSynchron(boolean state) {
		editor.putBoolean(BP_HISTORY_SYNCHRONIZATION, state);
		editor.commit();
	}

	public boolean getBpSynchron() {
		return mSharedPreferences.getBoolean(BP_HISTORY_SYNCHRONIZATION, false);
	}

	public void setSugerSynchron(boolean state) {
		editor.putBoolean(SUGER_HISTORY_SYNCHRONIZATION, state);
		editor.commit();
	}

	public boolean getSugerSynchron() {
		return mSharedPreferences.getBoolean(SUGER_HISTORY_SYNCHRONIZATION, false);
	}
}
